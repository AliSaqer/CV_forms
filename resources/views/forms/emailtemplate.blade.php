...
<body style="margin: 0; padding: 0; font-family: Arial, sans-serif;">
    ...
    <div style="max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e5e5e5; border-radius: 10px;">
        ...
        <div style="margin-bottom: 20px;">
            <p>Hello,</p>
            <p>This is a sample professional email template. You can customize it as needed for your email content.</p>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis eget nulla ut metus vehicula tincidunt.</p>
