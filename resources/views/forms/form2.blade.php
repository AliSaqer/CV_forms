        ...
        @csrf
            ...
            @include('forms.errors')
                ...
                <div class="mb-3">
                    ...
                    class="form-control @error('name') is-invalid @enderror " placeholder="name" @error('name')
                        autofocus
                    @enderror  value="{{old('name','ahmed')}}">
                    @error('name')
                ...
                <div class="mb-3">
                    ...
                    class="form-control @error('email') is-invalid @enderror" placeholder="email" @error('email') autofocus @enderror value="{{old('email')}}">
                    @error('email')
                    <small class="invalid-feedback">{{$message}}</small>
                    @enderror
                ...
                <div class="mb-3">
                    ...
                    class="form-control @error('phone') is-invalid @enderror" placeholder="phone" @error('phone') autofocus @enderror value="{{old('phone')}}">
                    @error('phone')
                    <small class="invalid-feedback">{{$message}}</small>
                    @enderror
                ...
                <div class="mb-3">
                    ...
                    is-invalid
                    @enderror" placeholder="date of birth" @error('dob')
                        autofocus
                ...
                <div class="mb-3">
                    ...
                    <input type="date" name="start" class="form-control @error('start')
                        is-invlaid
                    @enderror" placeholder="start fucking" @error('start')
                        autofocus
                ...
                <div class="mb-3">
                    ...
                    <input type="date" name="end" class="form-control @error('end')
                        is-invalid
                    @enderror" placeholder="end fucking" @error('end')
                        autofocus
                ...
                <div class="mb-3">
                    ...
                    <input type="radio" name="gender" id="male" value="male" @checked(old('gender' == 'male'))><label for="male">male</label><br>
                ...
                <div class="mb-3">
                    ...
                    <select name="education" class="form-control">
                        ...
                        <option {{old('education')=='high_school' ? 'selected': ''}} value="high_school">high school</option>
